...
_BASE_PARAMETERS: list[dict] = [
    ...
    {"key": "dodoland_busy_town_reach", "cog": "dodoland", "type": "int", "default": 120,
     "label": "A town looks busy at this much reach",
     "description": "How many different people somebody has to have reached before their town is drawn as full as it gets: the widest ground, the most ordinary houses filling in around what they built, and the busiest streets. Reach is the one thing DodoLand actually measures, so it is the one thing that changes the town rather than any single building in it. The curve is logarithmic, so the difference between reaching five people and fifty shows far more than between two hundred and three hundred."},
