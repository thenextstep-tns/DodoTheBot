...
_BASE_PARAMETERS: list[dict] = [
    ...
    {"key": "dodoland_town_size", "cog": "dodoland", "type": "int", "default": 10,
     "label": "Town size (px)",
     "description": "Base diameter of a town marker at 100% zoom. Every town is drawn between one and three times this, on a square-root scale, so a newcomer stays visible beside somebody with a year's head start."},
