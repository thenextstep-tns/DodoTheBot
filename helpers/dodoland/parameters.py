...
_BASE_PARAMETERS: list[dict] = [
    ...
    {"key": "dodoland_town_size", "cog": "dodoland", "type": "int", "default": 120,
     "label": "Town size (map units)",
     "description": "How wide a town is drawn, in the base image's own pixels. This is a size on the map, not on the screen: a town scales with the world, so zooming out shrinks it exactly as it shrinks the coastline. Raise it if towns look like specks on a large map."},
