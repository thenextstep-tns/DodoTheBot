...
PET_SUMMON_CHOOSE_INEXACT = "You have no pet called '{pet_name}'. The closest ones are — which did you mean?"
PET_SUMMON_DID_YOU_MEAN = "You have no pet called '{pet_name}'. Did you mean **{name}** ({kind})?"
PET_SUMMON_CANCELLED = "Alright — nobody summoned."
PET_SUMMON_PLACEHOLDER = "Pick a pet"
...
# --- Fight (cat scraps) ---
FIGHT_TITLE = "Cat scrap"
FIGHT_SIGNUP_TITLE = "A fight is starting"
FIGHT_SIGNUP = "It smells like a fight in the air! Will you send your cat to fight?\n\nStarting in **{seconds}s**."
FIGHT_SIDE_A = "🟥 Side A"
FIGHT_SIDE_B = "🟦 Side B"
FIGHT_SIDE_EMPTY = "*nobody yet*"
FIGHT_CHOOSE = "Which cat is going in?\n{hint}"
FIGHT_SUMMON_HINT = "-# You can pick who fights for you any time with `summon <name>` and the 🥊 button."
FIGHT_NO_MORE_CATS = "You have no other cats to send. That is everybody."
FIGHT_CAT_GONE = "That cat is not yours any more."
FIGHT_JOINED = "In they go: {names}"
FIGHT_NOBODY_CAME = "Nobody sent a cat. The fight is off and everyone goes back to sleep."
FIGHT_NO_OPPONENT = "Dodo could not find a single cat willing to stand opposite. The fight is off."
FIGHT_BOT_OWNER = "Dodo"
FIGHT_DRAFTED = "Nobody else turned up, so Dodo has borrowed **{name}** off somebody. Nothing is at stake for them."
FIGHT_SIDES_FULL = "Both sides are full. You are too late for this one."
FIGHT_OVER_ALREADY = "That fight has already started."
FIGHT_WINNER = "**{team}** wins."
FIGHT_NO_WINNER = "Nobody wins. Both sides lose interest at the same moment."
FIGHT_NOT_SAVED = "The result could not be written down, so nobody lost anything. Lucky."
